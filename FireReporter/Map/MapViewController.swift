...
//        setupMapUI()
//        confirmButtonDesign()
//        mapViewModel.configureLocationManager()
//        giveLocationPermission()
//        annotationMarkerHandler()
//    }
//    
...
////    }
//    
//    func giveLocationPermission(){
//        mapViewModel.locationManagerAuthorization {
...
//    
//    func updateLocation(){
//        mapViewModel.updateLocation { location in
//            self.pinUserLocation(location)
...
//    }
//    
//    func annotationMarkerHandler(){
//        let longPressRecognizer = UILongPressGestureRecognizer(target: self, action: #selector(markAnnotation(_:)))
//        let removeAnnotation = UITapGestureRecognizer(target:self, action: #selector(removeAnnotation(_:)))
//        longPressRecognizer.minimumPressDuration = 0.5
//        mapView.addGestureRecognizer(removeAnnotation)
//        mapView.addGestureRecognizer(longPressRecognizer)
//    }
//    
//    @objc func markAnnotation(_ gestureRecognizer: UIGestureRecognizer){
//        if gestureRecognizer.state != .began { return }
//        
//        let touchPoint = gestureRecognizer.location(in: mapView)
//        let touchMapCoordinate = mapView.convert(touchPoint, toCoordinateFrom: mapView)
...
//    }
//    
//    @objc func removeAnnotation(_ gestureRecognizer: UIGestureRecognizer){
//        mapView.annotations.forEach { annotation in
//            coordinates = nil
//            self.mapView.removeAnnotation(annotation)
//        }
